...
%type <node_info> parameter_list func_body proc_body iter_body // deref_expression
...
iter_body: '{' statement_list '}' {$$.treenode = $2.treenode;}
| '{' '}'
| statement {$$.treenode = $1.treenode;};
...
| logic_expression logic pr_expression {
...
| ar_expression arithmetic pr_expression {
...
pr_expression: '(' expression ')' {$$.treenode = $2.treenode;} /* brackets */ | ID {$$.treenode = crnode_leaf($1.str, id_plain);};
| literal {$$.treenode = crnode_leaf($1.str, literal);}; | func_call {$$.treenode = $1.treenode;};
| ADDRESS pr_expression {$$.treenode = crnode_address("DEREF", $2.treenode);};
